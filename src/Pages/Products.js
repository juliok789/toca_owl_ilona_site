      ...
      <div className="container">
        <header className='header'>
          ...
          <div className="header__basket basket-header">
            <p className="basket-header__desc"><span>3 товара</span><br />на сумму 3 500 ₽</p>
          <button className='basket-header__btn'><svg width="21" height="21" viewBox="0 0 21 21" fill="none" xmlns="http://www.w3.org/2000/svg">
